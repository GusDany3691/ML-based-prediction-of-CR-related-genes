...
AgeGenes = readRDS("M:/gusdany/Documents/AgeingFinal.rds")
CrGenes = readRDS("M:/gusdany/Documents/CrFinal.rds")
...
for ( i in 1:length(Instances)){   
  ...
  print(FinalFrame)
  saveRDS(InstancesList, file = "InstancesList.rds")
}

saveRDS(InstancesList, file = "InstancesList.rds")

# START HERE IF ALREADY DATABASE CREATED
#InstancesList = readRDS("InstancesList.rds")
...
write.table(FeatureValue, file = "C:/Users/gusdany/Desktop/KeggGenes.csv", sep = ",", col.names = NA, qmethod = "double")
...
write.table(PathFeatureValue, file = "C:/Users/gusdany/Desktop/KeggPaths.csv", sep = ",", col.names = NA, qmethod = "double")
...
KeggPaths = read.csv("D:/gusdany/Desktop/El Proyecto/Databases/DataSetsHagr/Final/OMA/KeggPaths.csv")
KeggGenes = read.csv("D:/gusdany/Desktop/El Proyecto/Databases/DataSetsHagr/Final/OMA/KeggGenes.csv")

KeggPaths$X %in% AgeGenes
Class = ifelse(KeggPaths$X %in% CrGenes, "CR", "NotCR")

KeggPaths$Class = Class
KeggGenes$Class = Class

write.csv(KeggPaths,"D:/gusdany/Desktop/El Proyecto/Databases/DataSetsHagr/Final/OMA/KeggPaths.csv")
write.csv(KeggGenes,"D:/gusdany/Desktop/El Proyecto/Databases/DataSetsHagr/Final/OMA/KeggGenes.csv")
