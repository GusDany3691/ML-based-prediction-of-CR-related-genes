...
Oma_Mouse = read.csv('/ML-based-prediction-of-CR-related-genes/Data/External/OMA/ezOMA_Mouse.csv')
Oma_Fly = read.csv('/ML-based-prediction-of-CR-related-genes/Data/External/OMA/ezOMA_Fly.csv')
Oma_Worm = read.csv('/ML-based-prediction-of-CR-related-genes/Data/External/OMA/ezOMA_Worm.csv')
Oma_Yeast = read.csv('/ML-based-prediction-of-CR-related-genes/Data/External/OMA/ezOMA_Yeast.csv')

# AGEING AND DIETARY RESTRICTION
AgeingModels = read.csv('/ML-based-prediction-of-CR-related-genes/Data/External/HAGR/genage_models.csv')
DRframe = read.csv("/ML-based-prediction-of-CR-related-genes/Data/External/HAGR/gendr_manipulations.csv")
...
##### LOAD CALORIC RESTRICTION MODELS ########################################################################################

cMusculus  = DRframe[DRframe$species == 'Mus musculus',]$gene.symbol
cMusculusId  = DRframe[DRframe$species == 'Mus musculus',]$entrez.gene.id

cDrosophila  = DRframe[DRframe$species == 'Drosophila melanogaster',]$gene.symbol
cDrosophilaId  = DRframe[DRframe$species == 'Drosophila melanogaster',]$entrez.gene.id

cElegans  = DRframe[DRframe$species == 'Caenorhabditis elegans',]$gene.symbol
cElegansId  = DRframe[DRframe$species == 'Caenorhabditis elegans',]$entrez.gene.id

cCerevisiae  = DRframe[DRframe$species == 'Saccharomyces cerevisiae',]$gene.symbol
cCerevisiaeId  = DRframe[DRframe$species == 'Saccharomyces cerevisiae',]$entrez.gene.id
...
ecHumanMouse = OmaFrame(RelationsDataset = Oma_Mouse, ModelSymbol, ModelGenes = cMusculus,
                        ModelIDs = cMusculusId, ModelMart, Database = 'entrezgene_id', ModelName)
...
ecHumanFly = OmaFrame(RelationsDataset = Oma_Fly, ModelSymbol, ModelGenes = cDrosophila,
                      ModelIDs = cDrosophilaId, ModelMart, Database = 'entrezgene_id', ModelName)
...
ecHumanWorm = OmaFrame(RelationsDataset = Oma_Worm, ModelSymbol, ModelGenes = cElegans,
                       ModelIDs = cElegansId, ModelMart, Database = 'entrezgene_id', ModelName)
...
ecHumanYeast = OmaFrame(RelationsDataset = Oma_Yeast, ModelSymbol, ModelGenes = cCerevisiae,
                        ModelIDs = cCerevisiaeId, ModelMart, Database = 'entrezgene_id', ModelName)


##### COMBINE HUMAN GENES ###############################################################################################################

AgeingGenes = unique(eaHumanMouse$Human, eaHumanFly$Human, eaHumanWorm$Human, eaHumanYeast$Human)
CrGenes = unique(ecHumanMouse$Human, ecHumanFly$Human, ecHumanWorm$Human, ecHumanYeast$Human)

write.csv(AgeingGenes, '/ML-based-prediction-of-CR-related-genes/Data/Ageing and CR genes/AgeingGenes.csv')
write.csv(CrGenes, '/ML-based-prediction-of-CR-related-genes/Data/Ageing and CR genes/CrGenes.csv')

writeRDS(AgeingGenes, "/ML-based-prediction-of-CR-related-genes/Data/Ageing and CR genes/AgeingGenes.rds")
writeRDS(CrGenes, "/ML-based-prediction-of-CR-related-genes/Data/Ageing and CR genes/CrGenes.rds")
