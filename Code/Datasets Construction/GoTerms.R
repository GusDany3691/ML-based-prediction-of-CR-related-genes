...
save.csv(GoDataSet,"/ML-based-prediction-of-CR-related-genes/Data/Datasets/GoDataSet.CSV")
save.csv(sGoDataSet,"/ML-based-prediction-of-CR-related-genes/Data/Datasets/sGoDataSet.CSV")
