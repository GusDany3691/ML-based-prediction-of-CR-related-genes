...
GoDataSet = read.csv("C:/Users/gusdany/Desktop/El Proyecto/Databases/DataSetsHagr/GoDataSet.csv")
PathDipDataset = read.csv("C:/Users/gusdany/Desktop/El Proyecto/Databases/DataSetsHagr/PathDipDataset.csv")
...
# GUSTAVO'S
file = 'GO_BRF_Gmean_normal_Mm3_cv10o5i_sn76sp71_vi'#"sKEGG_BRF_Gmean_normal_Mm2_cv10o5i_sn85sp65_vi"
path = "C:/Users/gusdany/Desktop/El Proyecto/PythonVarimp/"
pathfile = paste(path, file, sep = "")
pathfile = paste(pathfile, ".csv", sep = "")
VarImp = read.csv(pathfile)
VarImp <- VarImp %>% column_to_rownames("Feature.1")
head(VarImp)

#VLAD'S
file = "Weights_dataframe_GoDataSet_latest_5NZV"
path = "C:/Users/gusdany/Downloads/results/results/Importance2/Final/"
pathfile = paste(path, file, sep = "")
pathfile = paste(pathfile, ".csv", sep = "")
VarImp = read.csv(pathfile)
VarImp$'Score' = VarImp$'Score' - min(VarImp$'Score') 
VarImp['Score'] = (VarImp['Score'] / VarImp['Score'][1,1]) * 100
VarImp <- VarImp %>% column_to_rownames("features")
VarImp[order(VarImp$Score, decreasing = TRUE),]
...
path = "C:/Users/gusdany/Downloads/results/results/Importance/Analysis/Final/"
pathfile = paste(path, file, sep = "")
pathfile = paste(pathfile, ".csv", sep = "")
pathfile
write.csv(VarImpStatistic, pathfile)
file